...
const displayExactPlaceFutureWeather = (city) => {
    let long;
    let lat;
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(position => {
            ...
            const api = `https://api.openweathermap.org/data/2.5/forecast?q=${city}&units=metric&lang=pl&APPID=342e58ac10157a7f0274028550e55fc5`
...
document.getElementById('local-weather-btn').addEventListener('click', displayFutureWeather);
...
sPWB.addEventListener("click", function () {
    ...
    return displayExactPlaceFutureWeather(inputCity);
